      ...
      <Card className="mb-8">
        ...
        <CardContent className="space-y-6">
          ...
          <div className="flex items-start space-x-4">
            ...
            <div className="text-left">
              <h3 className="font-medium text-foreground">Get your personalized report</h3>
              <p className="text-sm text-muted-foreground">Within 24 hours, you'll receive an email with 2-3 insurance recommendations tailored to your situation.</p>
            </div>
          </div>
          <div className="flex items-start space-x-4">
            <div className="w-8 h-8 bg-primary rounded-full flex items-center justify-center flex-shrink-0 mt-1">
